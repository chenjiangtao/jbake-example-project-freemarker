...
的插件，两个可能有冲突，自动把官方的这个给disable了……以为这个才是正统，其实是它妈渣……果断卸载了无多说。
好吧，打开后问题解决了，耗费了我4个小时的问题，就是因为一个“Enable”
